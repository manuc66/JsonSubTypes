    ...
    public sealed class JsonSubTypesGenerator : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(baseTypes.Collect(), static (spc, types) =>
            {
                ...
                spc.AddSource("JsonSubTypesAotConverterBases.g.cs", SourceText.From(EmitConverterBases(), System.Text.Encoding.UTF8));
        ...
        private static string EmitConverterBases()
        {
        ...
        {
            string discriminatorProperty = $"        protected override string DiscriminatorPropertyName => {SymbolDisplay.FormatLiteral(info.DiscriminatorPropertyName!, quote: true)};\n\n";

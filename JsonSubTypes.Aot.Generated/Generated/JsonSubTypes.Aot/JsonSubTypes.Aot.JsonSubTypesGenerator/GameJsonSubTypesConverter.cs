...
namespace JsonSubTypes.Aot.Generated
{
    ...
    public sealed class GameJsonSubTypesConverter : JsonConverter<global::JsonSubTypes.Aot.Generated.TestDomain.Game>
    {
        public override bool CanConvert(Type typeToConvert) => typeToConvert == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Game);

        public override void Write(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Game value, JsonSerializerOptions options)
        {
            if (value is null)
            {
            ...
            string payload;
            if (runtimeType == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Game))
            {
                if (IsRegistered(runtimeType))
                {
                    payload = SerializeBasePayload((global::JsonSubTypes.Aot.Generated.TestDomain.Game)value, options);
                }
                else
                {
                    WriteBaseObject(writer, (global::JsonSubTypes.Aot.Generated.TestDomain.Game)value, options);
                    return;
                }
            }
            ...
            string discriminatorName = "$GameKind";
        ...
        public override global::JsonSubTypes.Aot.Generated.TestDomain.Game? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (target == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Game))
            {
                return DeserializeBase(root, options);
            }
            return (global::JsonSubTypes.Aot.Generated.TestDomain.Game?)JsonSerializer.Deserialize(root.GetRawText(), options.GetTypeInfo(target));
        }
    ...
    private static bool TryWriteNestedObject(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Game value, Type runtimeType, JsonSerializerOptions options)
    {

        return false;
    }

    private bool TryWriteDynamic(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Game value, Type runtimeType, JsonSerializerOptions options)
    {
        if (_dynamicReverse.TryGetValue(runtimeType, out object? dynamicDiscriminator))
        {
            writer.WriteStartObject();
            string dynamicDiscriminatorName = "$GameKind";
            if (options.PropertyNamingPolicy != null)
            {
    ...
    private static string SerializeBasePayload(global::JsonSubTypes.Aot.Generated.TestDomain.Game value, JsonSerializerOptions options)
    {
    ...
    private static void WriteBaseObject(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Game value, JsonSerializerOptions options)
    {
        writer.WriteStartObject();
    ...
    private static global::JsonSubTypes.Aot.Generated.TestDomain.Game DeserializeBase(JsonElement root, JsonSerializerOptions options)
    {

...
namespace JsonSubTypes.Aot.Generated
{
    ...
    public sealed class GadgetJsonSubTypesConverter : JsonConverter<global::JsonSubTypes.Aot.Generated.TestDomain.Gadget>
    {
        public override bool CanConvert(Type typeToConvert) => typeToConvert == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Gadget);

        public override void Write(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Gadget value, JsonSerializerOptions options)
        {
            if (value is null)
            {
            ...
            string payload;
            if (runtimeType == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Gadget))
            {
                if (IsRegistered(runtimeType))
                {
                    payload = SerializeBasePayload((global::JsonSubTypes.Aot.Generated.TestDomain.Gadget)value, options);
                }
                else
                {
                    WriteBaseObject(writer, (global::JsonSubTypes.Aot.Generated.TestDomain.Gadget)value, options);
                    return;
                }
            }
        ...
        public override global::JsonSubTypes.Aot.Generated.TestDomain.Gadget? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (target == typeof(global::JsonSubTypes.Aot.Generated.TestDomain.Gadget))
            {
                return DeserializeBase(root, options);
            }
            return (global::JsonSubTypes.Aot.Generated.TestDomain.Gadget?)JsonSerializer.Deserialize(root.GetRawText(), options.GetTypeInfo(target));
        }
    ...
    private static bool TryWriteNestedObject(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Gadget value, Type runtimeType, JsonSerializerOptions options)
    {

        return false;
    }

    private bool TryWriteDynamic(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Gadget value, Type runtimeType, JsonSerializerOptions options)
    {
        if (_dynamicReverse.TryGetValue(runtimeType, out object? dynamicDiscriminator))
        {
            writer.WriteStartObject();
            string dynamicDiscriminatorName = "kind";
            if (options.PropertyNamingPolicy != null)
            {
    ...
    private static string SerializeBasePayload(global::JsonSubTypes.Aot.Generated.TestDomain.Gadget value, JsonSerializerOptions options)
    {
    ...
    private static void WriteBaseObject(Utf8JsonWriter writer, global::JsonSubTypes.Aot.Generated.TestDomain.Gadget value, JsonSerializerOptions options)
    {
        writer.WriteStartObject();
    string nameAge = "Age";
    ...
    private static global::JsonSubTypes.Aot.Generated.TestDomain.Gadget DeserializeBase(JsonElement root, JsonSerializerOptions options)
    {

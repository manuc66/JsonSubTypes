...
- Name-based type resolution stays scoped to the base type's assembly by default. Cross-assembly subtypes require an explicit opt-in: `[JsonSubTypesTypeResolution("AssemblyName")]` on the base type, a capability the Newtonsoft version does not have.
